...
def db_tables() -> None:
    ...
    """
    connection = db_connection(DB_FILEPATH)  # Connect to the db
    ...
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS habits (
            ...
            FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE -- Links habits to a specific user in the user table
        )
    """)
